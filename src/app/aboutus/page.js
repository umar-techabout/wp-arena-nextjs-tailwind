        ...
        <>
            ...
            <div className="md:px-20 xs:px-10 px-5">
                <div className="flex lg:justify-between justify-center items-center lg:flex-row flex-col">
                    <div className="lg:w-4/6 w-full">
                        ...
                        <ul className="my-4 ms-9 md:font-bold font-medium md:leading-9 leading-7" style={{ listStyleImage: `url(${listArrow.src})` }}>
                        ...
                        <div className=''>
                            ...
                            <div className='flex gap-5 items-center'>
                                <div className='xs:h-24 h-16 xs:w-24 w-16 bg-gray-800 rounded-full flex items-center justify-center flex-none'>
                                    <Image height={40} width={40} src={WpaSupportIcon} alt='Expert Team' />
                                </div>
                                <div className=''>
                ...
                <div className="flex lg:justify-between justify-center items-center lg:flex-row flex-col-reverse">
                    <div className='lg:w-2/6 w-full flex justify-center'>
                        <div className='border-8 border-solid border-[#ebf1ff] rounded-full h-80 w-80 p-8'>
                            <Image className="flex items-center justify-center object-contain mx-auto h-full" height={100} width={230} src={AboutUsOurValuesIcon} alt='About us' />
                        </div>
                    </div>
                    <div className="lg:w-4/6 w-full">
            ...
            <div className="md:px-20 xs:px-10 px-5">
                <div className="flex lg:justify-between justify-center items-center lg:flex-row flex-col">
                    ...
                    <div className='lg:w-2/6 w-full flex justify-center'>
                        <div className='border-8 border-solid border-[#ebf1ff] rounded-full h-80 w-80 p-8'>
                            <Image className="flex items-center justify-center object-contain mx-auto h-full" height={100} width={230} src={AboutUsOurVision} alt='About us' />
                        </div>
                    </div>
                </div>
            </div>
            <div className="md:px-20 xs:px-10 px-5">
                <div className="flex lg:justify-between justify-center items-center lg:flex-row flex-col-reverse">
                    <div className='lg:w-2/6 w-full flex justify-center'>
                        <div className='border-8 border-solid border-[#ebf1ff] rounded-full h-80 w-80 p-8'>
                            <Image className="flex items-center justify-center object-contain mx-auto h-[100%]" height={100} width={230} src={AboutUsOurVision} alt='About us' />
                        </div>
                    </div>
                    <div className="lg:w-4/6 w-full">
